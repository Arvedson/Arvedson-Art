...
const AddressSection = ({
  ...
  // Inicializar el mapa con la dirección actual si existe
  useEffect(() => {
    if (currentAddress?.location) {
      setMapCoords(currentAddress.location);
      if (mapInstance) {
        mapInstance.panTo(currentAddress.location);
        mapInstance.setZoom(20);
      }
    }
  }, [currentAddress, mapInstance]);
