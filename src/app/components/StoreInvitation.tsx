...
import { ShoppingBagIcon, ViewfinderCircleIcon , TrophyIcon } from "@heroicons/react/24/solid";
...
export default function StoreInvitation() {
  ...
  return (
    <section className={`relative py-6 md:py-24 overflow-hidden fade-in ${theme === 'dark' ? 'bg-gray-900' : 'bg-[var(--primary-bg)]'}`}>
          ...
          <div className="relative grid grid-cols-2 grid-rows-2 gap-4 h-[500px]">
            ...
            <div className="relative col-span-2 rounded-xl overflow-hidden shadow-2xl transform transition-all duration-500 hover:scale-95">
              ...
              <div className="absolute bottom-4 left-4 flex items-center space-x-2 bg-[var(--card)] px-4 py-2 rounded-lg shadow-md">
                ...
                <span className="font-medium text-[var(--foreground)]">+500 Cuadros vendidos; se el proximo!</span>
              </div>
            </div>
          </div>

          {/* Contenido persuasivo */}
          <div className={`space-y-6 ${theme === 'dark' ? 'text-gray-100' : 'text-[var(--foreground)]'}`}>
            <ViewfinderCircleIcon className="h-12 w-12 text-[var(--accent)] animate-pulse" />
            <h2 className="text-4xl md:text-5xl font-bold leading-tight">
              Descubre Obras Maestras<br />
  ...
  Ver Catálogo
            ...
            <div className="mt-12 grid grid-cols-3 gap-4 opacity-90">
              <div className="text-center">
                ...
                <div className="text-sm">Arte Original</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[var(--primary)]">✈️</div>
