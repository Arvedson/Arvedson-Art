...
const CarritoCompra: React.FC<CarritoCompraProps> = ({ onCloseCartModal }) => {
  ...
  const [activeTab, setActiveTab] = useState<
    "address" | "customer" | "payment" | "review"
  >("review");
  ...
  const handlePaymentSuccess = (paymentIntentId: string) => {
    setPaymentOrderId(paymentIntentId);
  ...
  const validateCheckout = () => {
    ...
    const emailFormatInvalid = customer?.email
    ...
    setValidationErrors((prev) => ({
      ...prev,
      ...missing,
      emailFormat: emailFormatInvalid,
    }));
  ...
  const handleSaveCustomerInfo = () => {
    ...
    const emailFormatInvalid = customerForm.email
  ...
  return (
    <div
      className={`bg-[var(--card)] rounded-xl shadow-lg p-6 space-y-6 border-2 ${
    ...
    >
        ...
        {address?.formattedAddress ? (
          ...
          <div className="bg-red-50/30 p-3 rounded-md border border-red-200">
            ...
            {validationErrors.address && (
              <ErrorMessage>Dirección requerida</ErrorMessage>
            )}
          </div>
        )}
      </div>
        ...
        {customer?.name || customer?.email || customer?.phone ? (
          <div className="bg-[var(--secondary)] p-3 rounded-md my-2 space-y-2">
            <div className="flex items-center gap-2 mb-1">
              ...
              <button
                ...
                aria-label="Remove customer info"
              >
                <X className="w-4 h-4 text-[var(--white)] hover:text-[var(--negative)]" />
              </button>
            </div>
          ...
          <div className="bg-red-50/30 p-3 rounded-md border border-red-200">
            ...
            {validationErrors.customer && (
              <ErrorMessage>Información requerida</ErrorMessage>
            )}
          </div>
        )}
      </div>
      ...
      <div className="space-y-4">
        {items.length === 0 ? (
          <p className="text-[var(--muted2)] text-center py-4">
      ...
      {showResetConfirmation && (
        <div className="fixed inset-0 bg-black/50 z-[1002] flex items-center justify-center p-4">
          <div className="bg-[var(--card)] rounded-xl p-6 max-w-md w-full border border-[var(--border)]">
            ...
            <p className="text-[var(--muted2)] mb-6">
              ...
              {activeTab === "address" && (
                <AddressSection
                  ...
                  onAddressSelect={(address) => {
                    ...
                    // No cambiar automáticamente de tab para permitir ver la ubicación
                  }}
                />
              )}
                ...
                <div className="space-y-4">
                  <div>
                    <label
                      ...
                      className="block text-sm text-[var(--muted2)] font-medium mb-1"
                    >
                      Nombre completo
                    </label>
                    <input
              ...
              {activeTab === "review" && (
                <div className="pr-2">
                  {items.map((item: CartItem) => (
                    <div
                      key={item.id}
                      className="flex justify-between py-3 border-b border-[var(--border)]"
                    >
                      <div>
      ...
      <style jsx global>{`
        ...
        .border-animation {
          ...
          border-image: linear-gradient(45deg, #ff6b6b, #4ecdc4, #45b7d1);
